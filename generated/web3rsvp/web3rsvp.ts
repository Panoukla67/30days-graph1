...
export class ConfirmAllCall extends ethereum.Call {
  get inputs(): ConfirmAllCall__Inputs {
    return new ConfirmAllCall__Inputs(this);
  }

  get outputs(): ConfirmAllCall__Outputs {
    return new ConfirmAllCall__Outputs(this);
  }
}

export class ConfirmAllCall__Inputs {
  _call: ConfirmAllCall;

  constructor(call: ConfirmAllCall) {
    this._call = call;
  }
...
export class ConfirmAllCall__Outputs {
  _call: ConfirmAllCall;
...
export class WithdrawalFundsCall extends ethereum.Call {
  get inputs(): WithdrawalFundsCall__Inputs {
    return new WithdrawalFundsCall__Inputs(this);
  }

  get outputs(): WithdrawalFundsCall__Outputs {
    return new WithdrawalFundsCall__Outputs(this);
  }
}

export class WithdrawalFundsCall__Inputs {
  _call: WithdrawalFundsCall;

  constructor(call: WithdrawalFundsCall) {
    this._call = call;
  }
...
export class WithdrawalFundsCall__Outputs {
  _call: WithdrawalFundsCall;
